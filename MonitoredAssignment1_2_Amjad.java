...
public class MonitoredAssignment1_2_Amjad {
	...
	public static void main (String[] args) {
		...
		// NumberFormatException("Illegal Input") is thrown			
	...
	public static String signForSubtraction(String op1, String op2) {
		...
		if (op1Modified.length() == op2Modified.length()) {
			...
			for (int indexForSign = 0; indexForSign < op1Modified.length();) {

				int m = op1Modified.charAt(indexForSign) - '0';	//TODO: int intOp1
				int n = op2Modified.charAt(indexForSign) - '0';	//TODO: int intOp2
